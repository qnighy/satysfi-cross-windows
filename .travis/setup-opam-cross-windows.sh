...
if [[ "$SATYSFI_TARGET" = "windows32" ]]; then
  TOOLPREF32=/usr/lib/mxe/usr/bin/i686-w64-mingw32.shared- opam install -y conf-gcc-windows32
else
  TOOLPREF64=/usr/lib/mxe/usr/bin/x86_64-w64-mingw32.shared- opam install -y conf-gcc-windows64
fi
